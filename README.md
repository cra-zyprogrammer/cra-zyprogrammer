...
<a href="https://instagram.com/shubh_verse_" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/instagram.svg" alt="shubh_verse_" height="30" width="40" /></a>
...
- 📄 **Shubham Singh** — *"EfficientNet-B4 for Multiclass Dental Disease Classification using Deep Learning,” NetCrypt International Confrenece
on Network, Cryptography & Security , **Jawaharlal Nehru University**, 2026, Paper ID 1260, IEEE Xplore."*
- 📖 **Shubham Singh** — *"Recommendations for the Future of Artificial Intelligence: Opportunities, Ethics, and Challenges"* — **Bentham Science Publishers** (Accepted)

---

### 🏆 Certifications & Achievements

- 🏅 **Google Digital Marketing Professional Certificate** – **Google Digital Unlocked** (March 2021)
- 🥇 **Python 101 Data Science** – **IBM Developer** Skills Certification (July 2021)
- 🐍 **Android App Development with Kotlin** – **Udemy** Skills Certification (March 2022)
- 📊 **Google Data Analytics Professional Certificate** — **Coursera** (Jun 2026)
